    ...
    >
      <div class="c-armageddon-container">
        ...
        <div class="c-armageddon-resources-container">
          <div>
            你拥有 <span class="c-remnants-amount">{{ format(remnants, 2) }}</span> 遗物。
          </div>
          <div>
            你拥有 <span class="c-remnants-amount">{{ format(realityShards, 2) }}</span> 现实碎片。
